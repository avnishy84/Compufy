...
// ---------------------------------------------------------------------------
// Test harness â€” mirrors the @for/@empty blocks with a mutable `founder`
...
describe('WhoWeAreComponent', () => {
  ...
  // 5.2 â€” renders without errors using FOUNDER_DATA
  describe('renders with FOUNDER_DATA', () => {
    ...
    it('should render the founder summary', () => {
      const fixture = TestBed.createComponent(WhoWeAreComponent);
      fixture.detectChanges();
      // Summary is long â€” check a distinctive substring
      expect(fixture.nativeElement.textContent).toContain('Avnish Yadav is a full-stack');
    });
  });

  // 5.3 â€” @empty fallback blocks render when arrays are empty
  ...
  // 5.4 â€” /who-we-are route exists and uses loadComponent
